...
# Scheduler
DEFAULT_SCHEDULER_TIMEZONE = 'Asia/Dubai'
DEFAULT_CRON_RECOMMENDATIONS_HOUR = 3
DEFAULT_CRON_RECOMMENDATIONS_MINUTE = 0
DEFAULT_CRON_CACHE_REFRESH_HOUR = 4
DEFAULT_CRON_CACHE_REFRESH_MINUTE = 0
DEFAULT_CRON_MAX_RETRIES = 3
DEFAULT_CRON_RETRY_DELAY_SECONDS = 60

# LLM (AI Analysis)
DEFAULT_LLM_TIMEOUT = 45  # seconds
DEFAULT_LLM_CACHE_TTL_HOURS = 24  # 24 hours
DEFAULT_LLM_CACHE_ENABLED = True
DEFAULT_LLM_RATE_LIMIT_MAX_REQUESTS = 10  # requests per time window
DEFAULT_LLM_RATE_LIMIT_TIME_WINDOW = 60  # seconds (1 minute)
LLM_ESTIMATED_COST_PER_CUSTOMER = 0.001  # USD
LLM_ESTIMATED_COST_PER_ROUTE = 0.002  # USD
